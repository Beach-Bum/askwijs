  ...
  return (
    <div className="min-h-screen bg-[#08090a] text-[#f7f8f8]" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <main className="max-w-[720px] mx-auto px-6 py-16">
        <h1 className="text-[36px] font-medium tracking-[-0.02em] mb-8">Privacy Policy</h1>
        <div className="space-y-8 text-[15px] text-[#8a8f98] leading-[1.7]">
          <section>
            <h2 className="text-[18px] font-medium text-[#f7f8f8] mb-3">What we collect</h2>
          ...
          <section>
            <h2 className="text-[18px] font-medium text-[#f7f8f8] mb-3">How we use it</h2>
          ...
          <section>
            <h2 className="text-[18px] font-medium text-[#f7f8f8] mb-3">Data storage</h2>
          ...
          <section>
            <h2 className="text-[18px] font-medium text-[#f7f8f8] mb-3">Your rights (GDPR)</h2>
          ...
          <section>
            <h2 className="text-[18px] font-medium text-[#f7f8f8] mb-3">Cookies</h2>
            <p>We use only essential cookies for authentication. No tracking cookies, no analytics scripts, no third-party ad pixels.</p>
          </section>

          <section>
            <h2 className="text-[18px] font-medium text-[#f7f8f8] mb-3">Contact</h2>
            <p>For privacy questions or data requests: <a href="mailto:privacy@askwijs.ai" className="text-[#5e6ad2] hover:underline">privacy@askwijs.ai</a></p>
          </section>
